...
<div class="form-content">
    <form method="POST" action="{{ route('comments.store') }}" class="form-general comments">
        ...
        <div class="form-group fs-5">
            <label for="start-label-title">Put down your calification:</label>
        </div>
        ...
        <div class="form-group"><input type="hidden" name="article_id" value="{{ $article->id }}">
        </div>

        <input type="submit" value="Submit" class="btn-submit btn-comment mt-2">
